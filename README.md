...
Claude Code の機能と使い方を **965問のクイズ** で学ぶアプリ。スマホでもPCでも。
...
| カテゴリ | 問題数 | 内容 |
|---------|--------|------|
| Memory | 83問 | CLAUDE.md、@import、メモリシステム |
| Skills | 84問 | カスタムスキル、スラッシュコマンド |
| Tools | 87問 | Read, Edit, Bash, Glob, Grep |
| Commands | 118問 | CLI コマンド、フラグ |
| Extensions | 186問 | MCP、Hooks、サブエージェント、プラグイン |
| Session | 214問 | セッション管理、コンテキスト、履歴 |
| Keyboard | 63問 | ショートカット、Vim モード |
| Best Practices | 109問 | 効果的な使い方、プロンプト設計 |
