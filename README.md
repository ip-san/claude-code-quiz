...
Claude Code の機能と使い方を **762問のクイズ** で学ぶアプリ。スマホでもPCでも。
...
| パッケージ | 用途 |
|-----------|------|
| [Vitest](https://vitest.dev/) 4 | ユニットテスト（1037テスト） |
| [Playwright](https://playwright.dev/) | E2E + Visual Regression テスト（78テスト） |
