...
Claude Code の機能と使い方を **905問のクイズ** で学ぶアプリ。スマホでもPCでも。
...
| Commands | 113問 | CLI コマンド、フラグ |
| Extensions | 176問 | MCP、Hooks、サブエージェント、プラグイン |
| Session | 195問 | セッション管理、コンテキスト、履歴 |
| Keyboard | 57問 | ショートカット、Vim モード |
| Best Practices | 98問 | 効果的な使い方、プロンプト設計 |
