...
Claude Code は強力なAIコーディングアシスタントですが、その機能は多岐にわたり、公式ドキュメントを読むだけでは全ての機能を把握・習得することが難しいと感じました。

- **膨大な機能**: メモリシステム、ツール群、スラッシュコマンド、キーボードショートカット、MCP連携など
- **実践的な知識が必要**: 「知っている」と「使いこなせる」の間には大きなギャップがある
- **継続的な学習**: 一度読んだだけでは忘れてしまう

そこで、**アクティブリコール（能動的な想起）** と **スペーシング効果（分散学習）** を活用したクイズ形式の学習ツールを作成しました。間違えた問題を繰り返し出題する「苦手問題モード」により、効率的に知識を定着させることができます。
