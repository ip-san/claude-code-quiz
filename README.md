...
Claude Code の機能と使い方を **985問のクイズ** で学ぶアプリ。スマホでもPCでも。
...
| カテゴリ | 問題数 | 内容 |
|---------|--------|------|
| Memory | 87問 | CLAUDE.md、@import、メモリシステム |
| Skills | 88問 | カスタムスキル、スラッシュコマンド |
| Tools | 89問 | Read, Edit, Bash, Glob, Grep |
| Commands | 120問 | CLI コマンド、フラグ |
| Extensions | 187問 | MCP、Hooks、サブエージェント、プラグイン |
| Session | 215問 | セッション管理、コンテキスト、履歴 |
