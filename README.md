...
| カテゴリ | 問題数 | 内容 |
|---------|--------|------|
| Memory | 57問 | CLAUDE.md、@import、メモリシステム |
| Skills | 56問 | カスタムスキル、スラッシュコマンド |
| Tools | 65問 | Read, Edit, Bash, Glob, Grep |
| Commands | 99問 | CLI コマンド、フラグ |
| Extensions | 159問 | MCP、Hooks、サブエージェント、プラグイン |
| Session | 158問 | セッション管理、コンテキスト、履歴 |
| Keyboard | 45問 | ショートカット、Vim モード |
...
| パッケージ | 用途 |
|-----------|------|
| [Vitest](https://vitest.dev/) 4 | ユニットテスト（408テスト） |
