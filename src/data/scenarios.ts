...
export const SCENARIOS: readonly ScenarioData[] = [
  {
    ...
    steps: [
      ...
      {
        type: 'narrative',
        text: 'Claude Codeが動き始めた。Claudeが認証機能のコードを書き始めている。ファイルの作成、テストの実行、コードの修正…どんなツールが裏で動いているんだろう？',
      },
  ...
  },
  {
    ...
    steps: [
      ...
      {
        type: 'narrative',
        text: '「決済処理の周辺でタイムアウトしてるっぽい。エラーログを見てくれ」とClaudeに指示した。Claudeがログファイルを読み、コードをgrepし、該当箇所を特定していく。',
      },
