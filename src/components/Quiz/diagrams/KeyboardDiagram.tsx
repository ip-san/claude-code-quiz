...
function keycapClass(highlight?: boolean): string {
  const base =
    'inline-flex min-w-[2rem] items-center justify-center rounded-md border px-2 py-1 font-mono text-xs font-semibold shadow-[0_2px_0_0_rgba(0,0,0,0.12)] transition-none'
  if (highlight) {
