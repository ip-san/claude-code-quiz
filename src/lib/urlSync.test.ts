...
describe('parseUrlIntent', () => {
  ...
  describe('?category=', () => {
    it('parses a known category', () => {
      expect(parseUrlIntent('?category=memory')).toEqual({ kind: 'category', categoryId: 'memory' })
    })
  ...
  describe('?scenario=', () => {
    it('parses a known scenario id', () => {
      expect(parseUrlIntent('?scenario=scenario-onboard')).toEqual({
        kind: 'scenario',
        scenarioId: 'scenario-onboard',
      })
    })
  ...
  describe('priority ordering', () => {
    ...
    it('category beats scenario/view/mode', () => {
      expect(parseUrlIntent('?category=memory&scenario=scenario-onboard&view=progress&mode=weak')).toEqual({
        kind: 'category',
        categoryId: 'memory',
      })
    })
    ...
    it('scenario beats view/mode', () => {
      expect(parseUrlIntent('?scenario=scenario-onboard&view=progress&mode=weak')).toEqual({
        kind: 'scenario',
        scenarioId: 'scenario-onboard',
      })
    })
