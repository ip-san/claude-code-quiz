...
# 複数カテゴリ
/quiz-refine 1 memory skills tools
...
インポート機能を手動テストする場合のチェックリストは [IMPORT_TESTING_CHECKLIST.md](IMPORT_TESTING_CHECKLIST.md) を参照。テスト用 JSON は `src/__fixtures__/import/` にあります。
